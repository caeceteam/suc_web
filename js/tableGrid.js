	...
	$(params.selector).bootgrid({
        ...
        formatters: {
        	"commands": function(column, row) {
            	return "<a type=\"button\" href=\"" + params.editUrl + row.idInputType + "\" class=\"btn btn-icon command-edit waves-effect waves-circle\" data-row-id=\"" + row.id + "\"><span class=\"zmdi zmdi-edit\"></span></a> " + 
                	"<a id=\"sa-warning\" class=\"btn btn-icon command-delete waves-effect waves-circle\" data-row-id=\"" + row.idInputType + "\"><span class=\"zmdi zmdi-delete\"></span></a>";
            }
        }
