...
class User_diner extends CI_Controller
{
	...
	{
	    $this->email->from('suc@no-reply.com', 'Sistema u歯ico de Comedores');
	...
	/**
	 * Funci贸n que genera una contrase馻 en forma aleatorio
	 * @param    $chars_min largo minimo (opcional, default 6)
	 * @param    $chars_max largo m醲imo (opcional, default 8)
	 * @param    $use_upper_case boolean para indicar si se usan ma醩uculas (opcional, default false)
