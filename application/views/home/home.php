...
<body data-ma-header="teal">
	<header id="header" class="media">
		<div class="pull-left h-logo">
			<a href="index.html" class="hidden-xs"> SUC <!-- <small>Sistema Único de Comedores</small> -->
		...
		<ul class="pull-right h-menu">
			<li class="hm-search-trigger"><a href="" data-ma-action="search-open">
					<i class="hm-icon zmdi zmdi-search"></i>
			</a></li>

			<li class="dropdown hidden-xs hidden-sm h-apps"><a
				data-toggle="dropdown" href=""> <i class="hm-icon zmdi zmdi-apps"></i>
			</a>
				<ul class="dropdown-menu pull-right">
					<li><a href=""> <i class="palette-Red-400 bg zmdi zmdi-calendar"></i>
							<small>Calendar</small>
					</a></li>

					<li><a href=""> <i class="palette-Green-400 bg zmdi zmdi-file-text"></i>
							<small>Files</small>
					</a></li>
					<li><a href=""> <i class="palette-Light-Blue bg zmdi zmdi-email"></i>
							<small>Mail</small>
					</a></li>
					<li><a href=""> <i
					...
					<li><a href=""> <i class="palette-Blue-Grey bg zmdi zmdi-image"></i>
							<small>Gallery</small>
					</a></li>
				</ul></li>
			...
			<li class="dropdown hm-profile"><a data-toggle="dropdown" href=""> <img
					src="img/profile-pics/1.jpg" alt="">
			</a>
		...
		<div class="media-body h-search">
			<form class="p-relative">
				<input type="text" class="hs-input"
					placeholder="Search for people, files & reports"> <i
					class="zmdi zmdi-search hs-reset" data-ma-action="search-clear"></i>
			</form>
		</div>
	...
	<section id="main">
		<aside id="s-user-alerts" class="sidebar">
			<ul class="tab-nav tn-justified tn-icon m-t-10" data-tab-color="teal">
				<li><a class="sua-messages" href="#sua-messages" data-toggle="tab"><i
				...
				<li><a class="sua-tasks" href="#sua-tasks" data-toggle="tab"><i
			...
			<div class="tab-content">
				<div class="tab-pane fade" id="sua-messages">
					<ul
						class="sua-menu list-inline list-unstyled palette-Light-Blue bg">
					...
					<div class="list-group lg-alt c-overflow">
						<a href="" class="list-group-item media">
							...
							<div class="media-body">
								...
								<small class="lgi-text">Sorem ipsum dolor sit amet, consectetur
									adipiscing elit. Etiam mattis lobortis sapien non posuere</small>
							</div>
							...
							<div class="media-body">
								...
								<small class="lgi-text">Quisque non tortor ultricies, posuere
									elit id, lacinia purus curabitur.</small>
							</div>
						</a> <a href="" class="list-group-item media">
							<div class="pull-left">
							...
							<div class="media-body">
								...
								<small class="lgi-text">Donec congue tempus ligula, varius
									hendrerit mi hendrerit sit amet. Duis ac quam sit amet leo
									feugiat iaculis</small>
							</div>
						</a> <a href="" class="list-group-item media">
							<div class="pull-left">
							...
							<div class="media-body">
								...
								<small class="lgi-text">Duis tincidunt augue nec sem dignissim
									scelerisque. Vestibulum rhoncus sapien sed nulla aliquam
									lacinia</small>
							</div>
						</a> <a href="" class="list-group-item media">
							<div class="pull-left">
							...
							<div class="media-body">
								...
								<small class="lgi-text">Phasellus a ullamcorper lectus, sit amet
									viverra quam. In luctus tortor vel nulla pharetra bibendum</small>
							</div>
						</a>
					</div>

					<a href="" class="btn btn-float btn-danger m-btn"> <i
		...
		<aside id="s-main-menu" class="sidebar">
			...
			<ul class="smm-alerts">
				<li data-user-alert="sua-messages" data-ma-action="sidebar-open"
					data-ma-target="user-alerts"><i class="zmdi zmdi-email"></i></li>
				...
				<li data-user-alert="sua-tasks" data-ma-action="sidebar-open"
					data-ma-target="user-alerts"><i class="zmdi zmdi-view-list-alt"></i>
				</li>
			</ul>
			...
			<ul class="main-menu">
				...
				<li class="sub-menu"><a href="" data-ma-action="submenu-toggle"><i
					...
					<ul>
						...
						<li><a href="user_diner/send"> Gestion de Usuarios</a></li>
					</ul></li>
				...
				<li class="sub-menu"><a href="" data-ma-action="submenu-toggle"><i
					...
					<ul>
						...
						<li><a href="user_diner/search">Altas pendientes</a></li>
						<li><a href="user_diner/add">Nuevo Usuario</a></li>
						<li><a href="user_diner/save">Datos Usuarios</a></li>
					</ul></li>
			</ul>
		</aside>
			...
			<div class="container">
				...
				<div id="c-grid" class="clearfix" data-columns>
					<div class="card c-dark palette-Light-Blue bg">
						<div class="card-header">
							<h2>
								Website Impressions <small>Consectetur Ultricies Porta Fringilla</small>
							</h2>
						...
						<div class="card-body card-padding">
							<h2 class="m-t-0 m-b-15 c-white">
								<i class="zmdi zmdi-caret-up-circle m-r-5"></i> 987,453
							</h2>
					...
					<div class="card c-dark palette-Green-A700 bg">
						<div class="card-header">
							<h2>
								Website Traffics <small>Nullam Adipiscing Pellentesque</small>
							</h2>
						...
						<div class="card-body card-padding">
							<h2 class="m-t-0 m-b-15 c-white">
								<i class="zmdi zmdi-caret-up-circle m-r-5"></i> 356,785K
							</h2>
					...
					<div class="card c-dark palette-Blue-Grey bg">
						<div class="card-header">
							<h2>
								Total Sales <small>Purus Malesuada Consectetur</small>
							</h2>
						...
						<div class="card-body card-padding">
							<h2 class="m-t-0 m-b-15 c-white">
								<i class="zmdi zmdi-caret-down-circle m-r-5"></i> $458,778
							</h2>
					...
					<div class="card popular-post">
						<div class="card-header ch-img"
							style="background-image: url(img/headers/4.png); height: 150px;">
							<h2>
								Recent Posts <small>Venenatis Sollicitudin Ipsum</small>
							</h2>
						...
						<div class="card-body m-t-20">
							<div class="list-group lg-alt">
								<a href="" class="list-group-item media">
									...
									<div class="media-body">
										<div class="lgi-heading">David Villa Jacobs</div>
										<small class="lgi-text">Sorem ipsum dolor sit amet,
											consectetur adipiscing elit. Etiam mattis lobortis sapien non
											posuere</small>
									</div>
								</a> <a href="" class="list-group-item media">
									<div class="pull-left">
									...
									<div class="media-body">
										<div class="lgi-heading">Rudolph Perez</div>
										<small class="lgi-text">Phasellus a ullamcorper lectus, sit
											amet viverra quam. In luctus tortor vel nulla pharetra
											bibendum</small>
									</div>
								</a> <a href="" class="list-group-item view-more"> <i
									class="zmdi zmdi-long-arrow-right"></i> View all
								</a>
							</div>
						</div>
					</div>
					...
					<div class="card c-dark palette-Amber bg">
						<div class="card-header p-b-0">
							<h2>
								For the past 30 days <small>Tortor Magna Parturient</small>
							</h2>
							<ul class="actions a-alt">
								<li class="dropdown"><a href="" data-toggle="dropdown"> <i
										class="zmdi zmdi-more-vert"></i>
					...
					<div class="card c-dark palette-Grey bg recent-signups">
						<div class="card-header p-b-0">
							<h2>
								Most Recent Signups <small>Magna Cursus Malesuada</small>
							</h2>
							<ul class="actions a-alt">
								<li class="dropdown"><a href="" data-toggle="dropdown"> <i
										class="zmdi zmdi-more-vert"></i>
						...
						<div class="card-body">
							...
							<ul class="rs-list">
								...
								<li><a href=""> <img class="avatar-img"
										src="img/profile-pics/5.jpg" alt="">
								</a></li>
								<li><a href="">
								...
								<li><a href=""> <img class="avatar-img"
										src="img/profile-pics/4.jpg" alt="">
								</a></li>
								<li><a href="">
								...
								<li><a href=""> <img class="avatar-img"
										src="img/profile-pics/3.jpg" alt="">
								</a></li>
								<li><a href="">
										<div class="avatar-char">A</div>
								</a></li>
								<li><a href=""> <img class="avatar-img"
										src="img/profile-pics/9.jpg" alt="">
								</a></li>
								<li><a href="">
								...
								<li><a href=""> <img class="avatar-img"
										src="img/profile-pics/7.jpg" alt="">
								</a></li>
								<li><a href=""> <img class="avatar-img"
										src="img/profile-pics/6.jpg" alt="">
								</a></li>
								<li><a href=""> <img class="avatar-img"
										src="img/profile-pics/8.jpg" alt="">
								</a></li>
								<li><a href="">
					...
					<div class="card" id="todo-lists">
						<div class="card-header ch-dark palette-Purple-300 bg">
							<h2>
								Todo lists <small>Mattis Malesuada Risus</small>
							</h2>
							...
							<div class="list-group lg-alt">
									...
									<div class="pull-left">
										<div class="avatar-char ac-check">
											<input class="acc-check" type="checkbox" checked> <span
												class="acc-helper palette-Purple-300 bg">C</span>
										</div>
									</div>
								...
								<div class="list-group-item media">
									<div class="pull-left">
										<div class="avatar-char ac-check">
											<input class="acc-check" type="checkbox" checked> <span
												class="acc-helper palette-Purple-300 bg">E</span>
										</div>
									</div>
									<div class="media-body">
										<div class="lgi-heading">Morbi leo risus, porta ac consectetur
											ac, vestibulum at eros.</div>
								...
								<div class="list-group-item media">
									...
									<div class="media-body">
										<div class="lgi-heading">Nullam quis risus eget urna mollis
											ornare vel eu leo</div>
					...
					<div class="card">
						<div class="card-header ch-img"
							style="background-image: url(img/demo/note.png); height: 250px;"></div>
						<div class="card-header">
							<h2>
								Pellentesque Ligula Fringilla <small>by Malinda Hollaway on 19th
									June 2015 at 09:10 AM</small>
							</h2>
						</div>
						<div class="card-body card-padding">
							<p>Donec ullamcorper nulla non metus auctor fringilla. Cras justo
							...
							<a href="" class="view-more"><i
								class="zmdi zmdi-long-arrow-right"></i> View Article...</a>
						</div>
					</div>
				</div>
			</div>
...
<![endif]-->
	...
	<script
		src="vendors/bower_components/salvattore/dist/salvattore.min.js"></script>
