                    ...
                    <div class="card" id="profile-main">
                        <div class="pm-overview c-overflow">
                            <div class="pmo-pic">
								...
								<!--  Comentario a sacar	<h2 class="m-0 c-white"><?php echo $this->form_data->user_name . ' ' . $this->form_data->surname; ?></h2> -->
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="pmbb-body p-l-30">
									<div class="pmbb-view">
                                        <dl class="dl-horizontal">
                                            ...
                                            <textarea class="form-control auto-size" id="name" name="name">
                                            <?php echo $this->form_data->user_name . ' ' . $this->form_data->surname; ?></textarea>
