    ...
    <body data-ma-header="teal">
        <header id="header" class="media">
            <div class="pull-left h-logo">
                <a href="index.html" class="hidden-xs">
                    SUC
                    <small>Sistema ÃÂnico de Comedores</small>
                </a>
		...
		<?php $this->load->view('templates/header'); ?>
                    ...
                    <ul class="dropdown-menu pull-right dm-icon">
                        ...
                        <li>
                            <a href=""><i class="zmdi zmdi-settings"></i> Cambiar contraseÃÂ±a</a>
                        </li>
                    </ul>
                </li>
            </ul>
                ...
                <ul class="main-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul>
							...
							<li><a href="animations.html">AsignaciÃÂ³n de Roles</a></li>
                        </ul>
                    </li>
                </ul>
            </aside>
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-body card-padding">
                            <small>Ingrese los datos para la creaciÃÂ³n del tipo de insumo.</small>
									...
									<form role="form" action="<?php echo $action; ?>" class="input-type-form" method="POST">
										...
										<div class="form-group fg-float">
											<div class="fg-line" data-id="description">
												...
												<label class="fg-label">DescripciÃÂ³n</label>
											</div>
										</div>
